...
const User2 = () => {
  const [customizations2, setCustomizations] = useState(() => {
    const savedState = localStorage.getItem("customizations2");
    return savedState
  ...
  const [editableStr, setEditableStr] = useState(customizations2.name);

  useEffect(() => {
    localStorage.setItem("customizations2", JSON.stringify(customizations2));
  }, [customizations2, editableStr]);
    ...
    <>
      <div
        style={{
          margin: "20px",
          padding: "20px",
          backgroundColor: customizations2.backgroundColor,
          borderRadius: "10px",
        }}
      >
        ...
        <Space direction="vertical" style={{ float: "right" }}>
          ...
          <div style={{ width: "168px" }}>
            <span>Font Size : </span>
            <Slider
              defaultValue={customizations2.fontSize}
              min={10}
              max={40}
        ...
        <div style={{ fontSize: customizations2.fontSize }}>
          <p>
